...
### Что делать, если нету "Настроить" в разделе "Внешний вид"?

В таком случае надо открыть "Настройки" в левом меню, открыть раздел "Чтение" и поменять статическую страницу на ранее нами созданную.

![изображение](https://github.com/caz1que/PM02/assets/104842811/147354ac-1999-4bd4-b703-00cc6decc7a5)
